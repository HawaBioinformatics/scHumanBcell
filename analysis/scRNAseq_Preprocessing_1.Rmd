...
```{r}
# Re-run PCA using Bcell markers for downstream cluster analysis
...
```{r}
VlnPlot(pbmc, features = c("CD27", "CD19"))
...
VlnPlot(pbmc, features = c("CD27", "CD19"), slot = "counts", log = TRUE)
VlnPlot(pbmc, features = c("CD27", "CD19"), slot = "scale.data")
```
